...
public class MainView extends javax.swing.JFrame {
    ...
    public MainView() {
        initComponents();
        ImageIcon image = App.getNetwork().getCurrentUser().getProfilePicture();
        if(image != null){
            lblprofilePicture.setIcon(new ImageIcon(image.getImage().getScaledInstance(lblprofilePicture.getWidth(), lblprofilePicture.getHeight(), Image.SCALE_DEFAULT)));
              }
